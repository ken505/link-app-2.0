...
import { NoteSvg } from "src/components/Links/Svgicons/NoteSvg copy";
...
const ITEMS = [
  ...
  },
  {
    ...
    title: "Zenn",
    image: <ZennSvg className={classes.image}/>,
  },
  {
          ...
          <Link href={item.href} key={item.href}>
            <a className={classes.aTag}>
              <div>
                ...
                {item.description ? <p className={classes.description}>{item.description}</p> : null}
              </div>
            </a>
          </Link>
        );
