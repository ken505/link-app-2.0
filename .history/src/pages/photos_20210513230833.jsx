...
export default function Home() {
  return (
    <div className={classes.container}>
      ...
      />
      <p>Tarao</p>
      <Image src="/images/Mikan.jpg" alt="Mikan's photo " width={256} height={144} />
      <p>Mikan</p>
      <Image src="/images/Sagawa Toko.jpg" alt="Sagawa Toko's photo " width={256} height={144} />
      <p>Sagawa Toko</p>
      <Image src="/images/.jpg" alt=" " width={256} height={144} />
      <p></p>
      <Image src="/images/Komari.jpg" alt="Komari's photo " width={256} height={144} />
      <p>Komari</p>
      <Image src="/images/.jpg" alt=" " width={256} height={144} />
      <p></p>
      <Image src="/images/Mau.jpg" alt=" Mau's photo" width={256} height={144} />
      <p>Mau</p>
      <Image src="/images/Burio.jpg" alt="Burio's photo " width={256} height={144} />
      <p>Burio</p>
      <Image src="/images/Ikura.jpg" alt="Ikura's photo " width={256} height={144} />
      <p>Ikura</p>
      <Image src="/images/Meron.jpg" alt=" Meron's photo" width={256} height={144} />
      <p>Meron</p>
      <Image src="/images/.jpg" alt=" " width={256} height={144} />
      <p></p>
      <Image src="/images/.jpg" alt=" " width={256} height={144} />
